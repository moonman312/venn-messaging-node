...
function SendgridServiceStatus(response, success) {
  ...
  if (success) {
    ...
    if (this.message === 'Maximum credits exceeded') this.code = this.StatusCodes.LIMIT_EXCEEDED;
    else if (this.message === 'sendgrid error') this.code = this.StatusCodes.SERVICE_DOWN;
