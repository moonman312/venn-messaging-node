...
describe('sending an sms should fallback', function(){
		...
		it('to nexmo when twilio down', function(done){
			...
			nock('https://rest.nexmo.com')
				.post('/sms/json?from=15139453300&to=15129435544&text=message-1&api_key=nsldkfjdslkjf&api_secret=nsldkfjdslkjf')
				.reply(200, {"message": "success"});

			emailClient.initialize(process.env.VENN_API_KEY)
			emailClient.send({to:"15129435544", message:"message-1"}, function(err, result){
